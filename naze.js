...
return list[Math.floor(list.length * Math.random())]
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': '𝗩𝗶𝗼𝗹𝗲𝗻𝘁 𝗕𝗼𝘁', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Naze Dev,;;;\nFN:𝗩𝗶𝗼𝗹𝗲𝗻𝘁 𝗕𝗼𝘁\nitem1.TEL;waid=6285875158363:6285875158363\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
  const fkontk = {
	"key": {
...
reply(mess.wait)
let anu = await axios.get(`https://yt.nxr.my.id/yt2?url=${text}&type=video`)
...
if (!text) throw 'Masukkan Query Link!' 
reply(mess.wait)	
let anu = await axios.get(`https://yt.nxr.my.id/yt2?url=${text}&type=audio`)
naze.sendMessage(m.chat, { audio: { url: anu.data.url }, mimetype: 'audio/mpeg' }, { quoted: m })
}
break  
            case 'getvideo': {
...
if (!isPremium && global.db.data.users[m.sender].limit < 5) return m.reply(mess.endLimit) // respon ketika limit habis
		db.data.users[m.sender].limit -= 5 // -5 limit    
             ...
             let anu = await maker.textpro(link, q)
                naze.sendMessage(m.chat, { image: { url: anu }, caption: `Made by 𝗩𝗶𝗼𝗹𝗲𝗻𝘁 𝗕𝗼𝘁` }, { quoted: m })
             }
             break 
  case 'hoorror':{
...
reply(`Wait a moment while making the logo about 1 minute`) 
   ...
   break
case 'pornhub':{
if (!q) throw `Example: ${prefix + command} Megawati|chan`
  inilogo4 = args.join(" ")
inilogo9 = args.join(" ")
...
*Author:* ${anu.author}`,
footer: `*Cara simpan digalery :*
• Download videonya
• Buka terus klik titik 3 pojok kanan atas
• Lalu klik simpan!`,
buttons: buttons,
headerType: 4
  }
...
${ytta} ${prefix}linkgroup
${ytta} ${prefix}ephemeral *option*
${ytta} ${prefix}setppgc *image*
${ytta} ${prefix}setname *text*
${ytta} ${prefix}setdesc *text*
${ytta} ${prefix}group *option*
${ytta} ${prefix}editinfo *option*
${ytta} ${prefix}add *@user*
${ytta} ${prefix}kick *@user*
${ytta} ${prefix}hidetag *text*
${ytta} ${prefix}tagall *text*
${ytta} ${prefix}antilink *on/off*
${ytta} ${prefix}mute *on/off*
${ytta} ${prefix}promote *@user*
${ytta} ${prefix}demote *@user*
${ytta} ${prefix}vote *text*
${ytta} ${prefix}devote
${ytta} ${prefix}upvote
${ytta} ${prefix}cekvote
...
${ytta} ${prefix}playstore
${ytta} ${prefix}gsmarena
${ytta} ${prefix}jadwalbioskop
${ytta} ${prefix}nowplayingbioskop
${ytta} ${prefix}aminio
${ytta} ${prefix}wattpad
${ytta} ${prefix}webtoons
${ytta} ${prefix}drakor

*❐  D O W N L O A D  M E N U*

${ytta} ${prefix}tiktoknowm *url*
${ytta} ${prefix}tiktokwm *url*
${ytta} ${prefix}tiktokmp3 *url*
${ytta} ${prefix}instagram *url*
${ytta} ${prefix}twitter *url*
${ytta} ${prefix}twittermp3 *url*
${ytta} ${prefix}facebook *url*
${ytta} ${prefix}pinterestdl *url*
${ytta} ${prefix}ytmp3 *url*
${ytta} ${prefix}ytmp4 *url*
${ytta} ${prefix}getmusic *query*
${ytta} ${prefix}getvideo *query*
${ytta} ${prefix}umma *url*
${ytta} ${prefix}joox *query*
${ytta} ${prefix}soundcloud *url*

*❐  SEARCH MENU*

${ytta} ${prefix}play *query*
${ytta} ${prefix}yts *query*
${ytta} ${prefix}google *query*
${ytta} ${prefix}gimage *query*
${ytta} ${prefix}pinterest *query*
${ytta} ${prefix}wallpaper *query*
${ytta} ${prefix}wikimedia *query*
${ytta} ${prefix}ytsearch *query*
${ytta} ${prefix}ringtone *query*
${ytta} ${prefix}stalk *option query*

*❐  R A N D O M  M E N U*

${ytta} ${prefix}gbtku
${ytta} ${prefix}coffe
${ytta} ${prefix}quotesanime
${ytta} ${prefix}motivasi
${ytta} ${prefix}dilanquote
${ytta} ${prefix}bucinquote
${ytta} ${prefix}katasenja
${ytta} ${prefix}puisi
${ytta} ${prefix}couple
${ytta} ${prefix}anime
${ytta} ${prefix}waifu
...
${ytta} ${prefix}candy
${ytta} ${prefix}blackpinkneon
${ytta} ${prefix}deepsea
${ytta} ${prefix}scifi
${ytta} ${prefix}fiction
${ytta} ${prefix}berry
${ytta} ${prefix}fruitjuice
${ytta} ${prefix}biscuit
${ytta} ${prefix}wood
${ytta} ${prefix}chocolate
${ytta} ${prefix}matrix
${ytta} ${prefix}blood
${ytta} ${prefix}halloween
${ytta} ${prefix}wicker
${ytta} ${prefix}darkgold
${ytta} ${prefix}firework
${ytta} ${prefix}skeleton
${ytta} ${prefix}sand
${ytta} ${prefix}glue
${ytta} ${prefix}leaves
${ytta} ${prefix}magma
${ytta} ${prefix}lava
${ytta} ${prefix}rock
${ytta} ${prefix}bloodglas
${ytta} ${prefix}underwater
${ytta} ${prefix}textmaker
${ytta} ${prefix}honey
${ytta} ${prefix}ice
${ytta} ${prefix}watercolor
${ytta} ${prefix}multicolor
${ytta} ${prefix}snow
${ytta} ${prefix}harrypot
${ytta} ${prefix}harrypotter
${ytta} ${prefix}brokenglass
${ytta} ${prefix}waterpipe
${ytta} ${prefix}spooky
${ytta} ${prefix}circuit
${ytta} ${prefix}metallic
${ytta} ${prefix}demon
...
${ytta} ${prefix}transformer
${ytta} ${prefix}neondevil
${ytta} ${prefix}3davengers
${ytta} ${prefix}3dstone
${ytta} ${prefix}3dstone2
${ytta} ${prefix}summertime
${ytta} ${prefix}thunder
${ytta} ${prefix}window
${ytta} ${prefix}graffiti
${ytta} ${prefix}graffitibike
${ytta} ${prefix}pornhub
${ytta} ${prefix}glitch
${ytta} ${prefix}blackpink
${ytta} ${prefix}glitch2
${ytta} ${prefix}glitch3
${ytta} ${prefix}3dspace
${ytta} ${prefix}lion
${ytta} ${prefix}3dneon
${ytta} ${prefix}greenneon
${ytta} ${prefix}bokeh
${ytta} ${prefix}holographic
${ytta} ${prefix}bear
${ytta} ${prefix}wolf
${ytta} ${prefix}joker
${ytta} ${prefix}dropwater
${ytta} ${prefix}dropwater2
${ytta} ${prefix}thewall
${ytta} ${prefix}neonlight
${ytta} ${prefix}natural
${ytta} ${prefix}carbon
${ytta} ${prefix}pencil
${ytta} ${prefix}blackpink2
${ytta} ${prefix}neon
${ytta} ${prefix}neonlight2
${ytta} ${prefix}toxic
${ytta} ${prefix}strawberry
${ytta} ${prefix}discovery
${ytta} ${prefix}1917
${ytta} ${prefix}sci_fi
${ytta} ${prefix}ancient
${ytta} ${prefix}fabric
${ytta} ${prefix}hoorror
${ytta} ${prefix}whitebear
${ytta} ${prefix}juice
${ytta} ${prefix}batman
${ytta} ${prefix}multicolor
${ytta} ${prefix}collwall
${ytta} ${prefix}wonderful
${ytta} ${prefix}cool
${ytta} ${prefix}sketch
${ytta} ${prefix}marvel
${ytta} ${prefix}foggy
${ytta} ${prefix}writing
${ytta} ${prefix}halloweenfire
${ytta} ${prefix}halloween
${ytta} ${prefix}watercolor
${ytta} ${prefix}classic
...
${ytta} ${prefix}slot
${ytta} ${prefix}delttt
${ytta} ${prefix}tictactoe
${ytta} ${prefix}family100
${ytta} ${prefix}tebak *option*
${ytta} ${prefix}math *mode*
${ytta} ${prefix}suitpvp *@tag*

*❐  P R I M B O N  M E N U*

${ytta} ${prefix}nomorhoki
${ytta} ${prefix}artimimpi
${ytta} ${prefix}artinama
${ytta} ${prefix}ramaljodoh
${ytta} ${prefix}ramaljodohbali
${ytta} ${prefix}suamiistri
${ytta} ${prefix}ramalcinta
${ytta} ${prefix}cocoknama
${ytta} ${prefix}pasangan
${ytta} ${prefix}jadiannikah
${ytta} ${prefix}sifatusaha
${ytta} ${prefix}rezeki
${ytta} ${prefix}pekerjaan
${ytta} ${prefix}nasib
${ytta} ${prefix}penyakit
${ytta} ${prefix}tarot
${ytta} ${prefix}fengshui
${ytta} ${prefix}haribaik
${ytta} ${prefix}harisangar
${ytta} ${prefix}harisial
${ytta} ${prefix}nagahari
${ytta} ${prefix}arahrezeki
${ytta} ${prefix}peruntungan
${ytta} ${prefix}weton
${ytta} ${prefix}karakter
${ytta} ${prefix}keberuntungan
${ytta} ${prefix}memancing
${ytta} ${prefix}masasubur
${ytta} ${prefix}zodiak
...
${ytta} ${prefix}ttp
${ytta} ${prefix}toimage
${ytta} ${prefix}removebg
${ytta} ${prefix}sticker
${ytta} ${prefix}emojimix
${ytta} ${prefix}emojimix2
${ytta} ${prefix}tovideo
${ytta} ${prefix}togif
${ytta} ${prefix}tourl
${ytta} ${prefix}tovn
...
${ytta} ${prefix}owner
${ytta} ${prefix}report
${ytta} ${prefix}menu / ${prefix}help / ${prefix}?
${ytta} ${prefix}delete
${ytta} ${prefix}infochat
${ytta} ${prefix}quoted
${ytta} ${prefix}listpc
${ytta} ${prefix}listgc
${ytta} ${prefix}listonline
${ytta} ${prefix}speedtest
${ytta} ${prefix}menfes
${ytta} ${prefix}tinyurl
${ytta} ${prefix}isgd
${ytta} ${prefix}vurl
...
${ytta} ${prefix}react *emoji*
${ytta} ${prefix}chat *option*
${ytta} ${prefix}join *link*
${ytta} ${prefix}leave
${ytta} ${prefix}block *@user*
${ytta} ${prefix}unblock *@user*
${ytta} ${prefix}bcgroup *text*
${ytta} ${prefix}bcall *text*
${ytta} ${prefix}setppbot *image*
${ytta} ${prefix}setexif
${ytta} ${prefix}setmenu *option*`
let butts = [
{buttonId: `${prefix}owner`, buttonText: {displayText: 'OWNER BOT'}, type: 1},
{buttonId: `${prefix}ping`, buttonText: {displayText: 'INFO BOT'}, type: 1}
]
...
thumbnail: fs.readFileSync("./image/logo.jpg"),
